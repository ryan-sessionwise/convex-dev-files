...
<div class="bs-posts <?php echo $facetwp_additional_classes; ?>">
	<div class="bs-posts__list row">
		...
		while (have_posts()) : the_post();
			...
			$categories = get_object_taxonomies($post_type);
			$categories = implode(" | ", wp_get_object_terms(get_the_ID(), $categories,  array("fields" => "names")));
						...
						foreach ($display_order as $order => $item) {
							switch ($item) {
								...
								case 'excerpt':
									...
									break;
								case 'link':
									echo '<div class="bs-post__read-more"><p>' . $read_more_text . '</p></div>';
									break;
								default:
									break;
							}
